...
1. **Built-in image generation stage:** Codex uses its built-in `image_gen` tool to generate **one row candidate per animation row**. Each row candidate is a `4×2` sheet (`768×416`: eight populated 192×208 slots).
