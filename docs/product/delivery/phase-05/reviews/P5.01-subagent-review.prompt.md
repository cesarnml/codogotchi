# Adversarial review for P5.01 — Lite/RPG config schema + CLI guards

Base branch: main
Branch: agents/p5-01-lite-rpg-config-schema-cli-guards
...
- packages/cli/src/default-readers.ts
- packages/cli/src/loot.test.ts
- packages/cli/src/router-lite-rpg-guard.test.ts
- packages/cli/src/router.ts
- packages/cli/src/setup.ts
- packages/cli/src/sync.ts
- packages/cli/src/vacation.test.ts
