...
Deferred: Consolidating the injected primary `reader` enumeration; a listing-aware `readDirectory` overload already exists structurally but is intentionally not wired through the injected seam this ticket.
